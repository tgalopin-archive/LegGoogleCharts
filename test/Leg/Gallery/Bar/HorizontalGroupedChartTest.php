...
use Leg\GCharts\Gallery\Bar\HorizontalGroupedChart;
use Leg\GCharts\Tests\TestCase;

class HorizontalGroupedChartTest extends TestCase
{
	public function testBuild()
	{
		$chart = new HorizontalGroupedChart();
		...
		$this->assertEquals('bhg', $options['cht']);
	}
}
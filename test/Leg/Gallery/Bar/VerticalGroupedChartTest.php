...
use Leg\GCharts\Gallery\Bar\VerticalGroupedChart;
use Leg\GCharts\Tests\TestCase;

class VerticalGroupedChartTest extends TestCase
{
	public function testBuild()
	{
		$chart = new VerticalGroupedChart();
		...
		$this->assertEquals('bvg', $options['cht']);
	}
}